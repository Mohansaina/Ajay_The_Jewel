/**
 * AI Chatbot Widget - Atelier Premium Customization
 * white-label, zero external dependencies, luxury dark glassmorphic UI.
 */
(function () {
  ...
  function parseMarkdown(text) {
    ...
    html = html.replace(/\[(.*?)\]\((.*?)\)/g, (match, linkText, url) => {
      ...
      return `<a href="${isSafeUrl ? trimmedUrl : '#'}" target="_blank" rel="noopener noreferrer" style="color: #d4af37; text-decoration: underline; font-weight: 500;">${linkText}</a>`;
    });
  ...
  class AIChatbotWidget extends HTMLElement {
    constructor() {
      ...
      this.settings = {
        brandColor: "#d4af37",
        welcomeMessage: "Welcome to the Atelier. I am your AI Assistant. How can I help you design, track, or manage your jewelry bookings today?",
      ...
      this.apiHost = this.getAttribute("api-host") || (window.ChatbotConfig && window.ChatbotConfig.apiHost) || window.location.origin;
    }
    ...
    applySettings() {
      ...
      // Apply CSS variable for brand color styling
      ...
      avatarEl.src = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23d4af37"><path d="M12 2C6.477 2 2 6.477 2 12c0 1.88.519 3.638 1.419 5.148L2.05 21.8a.5.5 0 0 0 .584.585l4.651-1.37A9.957 9.957 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18c-1.578 0-3.07-.44-4.354-1.205a.5.5 0 0 0-.4-.055l-3.328.98.98-3.328a.5.5 0 0 0-.056-.4A7.957 7.957 0 0 1 4 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8zm-2-9a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm5 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/></svg>`;
    }
    ...
    render() {
      this.shadowRoot.innerHTML = `
        <style>
          :host {
            font-family: "Cinzel", "Bodoni Moda", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
            font-size: 14px;
            color: #F3F4F6;
            z-index: 999999;
            position: fixed;
          ...
          /* Chat Window Card (Glassmorphic Dark Mode) */
          .chat-window {
            width: 380px;
            height: 580px;
          ...
          .messages-log {
            ...
            background: radial-gradient(circle at center, rgba(30, 30, 30, 0.2) 0%, rgba(10, 10, 10, 0.5) 100%);
          }
          ...
          .message-row.visitor .bubble {
            background-color: var(--brand-color, #d4af37);
            color: #050505;
        ...
        <div class="widget-container bottom-right">
          ...
          <div class="chat-window">
            ...
            <div class="chat-footer">
              <textarea class="message-input" placeholder="Ask about orders, bookings, gold..." rows="1"></textarea>
            ...
            <div class="powered-by">
              Atelier Sydney &bull; Secure Chat
            </div>
          </div>
    ...
    loadConversation() {
      ...
      // If we don't have stored messages, show default welcome message and chips
    ...
    appendQuickReplyChips() {
      ...
      const existing = this.messagesLog.querySelector(".quick-replies-container");
      if (existing) existing.remove();

      const chips = [
        { label: "Track Order", text: "How do I track my order?" },
        { label: "Gold Quality", text: "Tell me about gold carat levels and alloys." },
        { label: "VIP Appointment", text: "How do I schedule a consultation?" },
        { label: "Resizing", text: "What is your ring resizing policy?" }
      ];
      ...
      chips.forEach(chip => {
        ...
        btn.addEventListener("click", () => {
          this.inputField.value = chip.text;
          this.sendMessage();
        });
        container.appendChild(btn);
      });

      this.messagesLog.appendChild(container);
    }
    ...
    async sendMessage() {
      ...
      const existingReplies = this.messagesLog.querySelector(".quick-replies-container");
      ...
      try {
        ...
        // Re-append quick reply chips after bot finishes speaking
        this.appendQuickReplyChips();
        this.scrollToBottom();
